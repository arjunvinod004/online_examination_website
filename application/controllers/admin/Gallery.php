...
class Gallery extends CI_Controller {
    ...
    public function add() {
        ...
        if(isset($_POST['add']))
		{
			...
			// $this->form_validation->set_rules('code', 'Code', 'callback_categorycode_exists');
			...
			if($this->form_validation->run() == FALSE) 
			{
				//echo "here";exit;
				$this->load->view('admin/includes/header');
			    $this->load->view('admin/catalog/add_categories'); 
			    $this->load->view('admin/includes/footer');
			}
			else
			{
                ...
                //         $this->load->view('admin/includes/header');
			    //         $this->load->view('admin/catalog/add_categories',$error); 
			    //         $this->load->view('admin/includes/footer');
				// 	}
				// }else{
                //     //echo "here2";exit;
            ...
            // print_r($data);exit;
                ...
                $this->Productmodel->insert_student_data($data);
...
public function edit(){
    if(isset($_POST['edit']))
    {
        ...
        // callback_validate_image_dimensions
        $this->form_validation->set_rules('userfile', 'Image', 'callback_validate_image_dimensions');
        // $this->form_validation->set_rules('category_name_ma', 'Malayalam', 'required');
        // $this->form_validation->set_rules('category_name_en', 'English', 'required');
        // $this->form_validation->set_rules('category_name_hi', 'Hindi', 'required');
