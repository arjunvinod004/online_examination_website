...
class Products extends CI_Controller {
    ...
    if (!empty($cartData)) 
    {
        foreach ($cartData as $product) {
            ...
            $availableStock = $this->Ordermodel->getCurrentStock($product['product_id'] , $date , $store_details_from_token->store_id);

            // Check if the requested quantity exceeds available stock
            if ($product['quantity'] > $availableStock) {
                $outOfStockProducts[] = [
                    'product_name' => $this->Ordermodel->getProductName($product['product_id']), // Assuming 'name' is the product name
...
<div class="accordion-item1">
    <h2 class="accordion-header" id="heading<?php echo $key; ?>">
        <button class="accordion-button collapsed d-none" type="button" data-bs-toggle="collapse"
            ...
            aria-controls="collapse<?php echo $key; ?>">All Products</button>
    </h2>
    <div id="collapse<?php echo $key; ?>" class="accordion-collapse collapse show" aria-labelledby<?php echo $key; ?>"
                        ...
                        <div class="left-column" style="width: 60%;float: left;">
                            ...
                            <div class="product-description mb-0"><?php echo substr($product_desc, 0, 60); ?>
                                <span class="more-text"
                                    style="display: none;"><?php echo substr($product_desc, 60); ?></span>
                                <span data-bs-toggle="modal" data-bs-target="#productDetails"
                                    class="seeMoreBtn pull-right" data-rate="<?php echo $productRate; ?>"
                                    data-image="<?php echo $path; ?>" data-desc="<?php echo $product_desc; ?>"
    ...
    ?>
                            <img src="<?php echo $path; ?>" data-bs-toggle="modal" data-bs-target="#productCustomize"
                                data-prodId="<?php echo $product['store_product_id']; ?>"
                                data-quantity="<?php echo $quantity; ?>" data-id="<?php echo $product['product_id']; ?>"
                                alt="Product Image" class="product-image customize <?php echo $css_class; ?>">
                            <!-- Add button -->
                            <div class="product" data-id="<?php echo $product['product_id']; ?>"
                                ...
                                <button data-quantity="<?php echo $quantity; ?>"
                                    data-prodId="<?php echo $product['store_product_id']; ?>"
                                    data-id="<?php echo $product['product_id']; ?>" class="add-button"
        ...
        $btntext = ($product['status'] == 1) ? (!empty($product['remarks']) ? $product['remarks'] : 'Available Soon'): 'ADD'; ?>
                            <img src="<?php echo $path; ?>" alt="Product Image"
                                class="product-image <?php echo $css_class; ?>">
                            <!-- Add button -->
...
<?php
    ...
    public function getVariantsAndAddons() {
        ...
        $product_details = $this->Productmodel->get_product_by_id($product_id);//print_r($product_details);exit;
        $variantsList = $this->Productmodel->getVariants($product,$store_id); //print_r($variants);
        $addonsList = $this->Productmodel->getAddons($product,$store_id); //print_r($addonsList);exit;
...
<div class="bg-white p-3 mb-3 rounded">
    <img src="<?php echo site_url() ?>uploads/product/<?php echo $product_details->image; ?>"
        class="img-fluid rounded w-100" alt="Food Image">
   ...
   ?>
                    <div class="col-3">
                        <div class="quantity-control d-flex align-items-center add-button1 mt-1">
                            <button class="btn1 add-btn">Add</button>
                            <div class="d-none quantity-group d-flex align-items-center"">
        <button class=" btn1 btn-sm decrement">-</button>
                                <input type="number" class="form-control1 d-inline-block variant-qty"
                                    value="<?php echo $quantity; ?>" min="0">
                                <button class="btn1 btn-sm increment">+</button>
                            </div>
                        </div>
                    </div>
                ...
                <div class="addon row" data-id="<?php echo $addon['addon_item_id']; ?>"
                    ...
                    <div class="col-2 mt-2">
                        <img src="<?php echo site_url() ?>uploads/product/<?php echo $addon['prod_image']; ?>"
                            style="width:50px;height:40px;" class="img-fluid rounded" alt="Food Image">
                    </div>
   ...
   ?>
                    ...
                    <div class="col-3">
                        <div class="quantity-control1 d-flex align-items-center add-button1 mt-1">
                            <button class="btn1 add-btn1">Add</button>
                            <div class="d-none quantity-group1 d-flex align-items-center">
                                <button class="btn1 btn-sm decrement1">-</button>
                                <input type="number" class="form-control1 d-inline-block addon-qty"
                                    value="<?php echo $quantity; ?>" min="0">
                                <button class="btn1 btn-sm increment1">+</button>
                            </div>
                        </div>
                    </div>
...
<div class="col">
    <button type="button" data-bs-dismiss="modal" data-bs-target="#productCustomize" data-id="<?php echo $product; ?>"
        class="btn btn-primary w-100 add-to-cart-popup">ADD ITEM - <span
...
<div class="accordion-item1">
    <h2 class="accordion-header" id="heading<?php echo $key; ?>">
        <button class="accordion-button collapsed d-none" type="button" data-bs-toggle="collapse"
            data-bs-target="#collapse<?php echo $key; ?>" aria-expanded="false"
            aria-controls="collapse<?php echo $key; ?>">All Productsss</button>
    </h2>
    <div id="collapse<?php echo $key; ?>" class="accordion-collapse collapse show" aria-labelledby<?php echo $key; ?>"
        data-bs-parent="#accordionExample">
        <div class="accordion-body">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    ...
                    <div class="product-grid">
                        ...
                        <div class="left-column" style="width: 60%;float: left;">
                            ...
                            <?php } ?>
                            <a href=""><span
                                    class="title"><?php echo $product['product_name_' . $language]; ?></span></a>
                            <span
                                class="current"><?php echo $this->session->userdata('currency_symbol'); ?><?php echo $productRate; ?></span>
                            <div class="product-description mb-0">
                                <?php echo substr($product['product_desc_' . $language], 0, 60); ?>
                                <span class="more-text"
                                    style="display: none;"><?php echo substr($product['product_desc_' . $language], 60); ?></span>
                                <span data-bs-toggle="modal" data-bs-target="#productDetails"
                                    class="seeMoreBtn pull-right" data-rate="<?php echo $productRate; ?>"
                                    data-image="<?php echo site_url() ?>uploads/product/<?php echo $product['image']; ?>"
                                    data-desc="<?php echo $product['product_desc_' . $language]; ?>"
                                    data-name="<?php echo $product['product_name_' . $language]; ?>"
                                    data-prodId="<?php echo $product['store_product_id']; ?>"
                                    data-id="<?php echo $product['product_id']; ?>">See More</span>
                            </div>
    ...
    ?>
        ...
        ?>
                            <img src="<?php echo site_url() ?>uploads/product/<?php echo $product['image']; ?>"
                                alt="Product Image" class="product-image <?php echo $css_class; ?>">
                            <!-- Add button -->
                            <div class="product" data-id="<?php echo $product['store_product_id']; ?>"
                                data-price="<?php echo $productRate; ?>"
                                data-quantity="<?php if(isset($quantity)){ echo $quantity;}else{ echo 1; } ?>">
                ...
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 col-12">
                    ...
                    <div class="product-grid">
                        ...
                        <div class="left-column" style="width: 60%;float: left;">
                            ...
                            <?php } ?>
                            <a href="">
                                <h4 class="title"><?php echo $product['product_name_' . $language]; ?>qq</h4>
                            </a>
                            <div class="product-description mb-0">
                                <?php echo substr($product['product_desc_' . $language], 0, 50); ?>
                                <span class="more-text"
                                    style="display: none;"><?php echo substr($product['product_desc_' . $language], 50); ?></span>
                            </div>
                            <button data-bs-toggle="modal" data-bs-target="#productDetails"
                                class="seeMoreBtn pull-right" data-rate="<?php echo $product['rate']; ?>"
                                data-image="<?php echo site_url() ?>uploads/product/<?php echo $product['image']; ?>"
                                data-desc="<?php echo $product['product_desc_' . $language]; ?>"
                                data-name="<?php echo $product['product_name_' . $language]; ?>"
                                data-prodId="<?php echo $product['store_product_id']; ?>"
                                data-id="<?php echo $product['product_id']; ?>">See More</button>
                            <!-- <div class="product-rating">⭐⭐⭐⭐☆</div> -->
                            <div class="price-area">
                                <span
                                    class="current"><?php echo $this->session->userdata('currency_symbol'); ?><?php echo $product['rate']; ?></span>
                                <div class="previous text-center txt-red">
                                </div>
                            </div>
                        </div>
