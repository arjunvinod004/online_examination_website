                                            ...
                                            <div class="form-group row mb-2">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text"
                                                        ...
                                                        class="form-control" id="datepicker3" name="contract_end_date"
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text"
                                                        ...
                                                        class="form-control" id="datepicker4" name="next_followup_date"
                                                        placeholder="">
...
fffffffffff
            ...
            $(document).ready(function() {
                ...
                $('#datepicker5').datepicker({
                    ...
                    endDate: '+365d' // Set maximum date to 365 days in the future
                    ...
                    dateAfter365Days.setDate(dateAfter365Days.getDate() + 365);
                    ...
                    $('#datepicker3').val(formattedDateAfter365);
                    ...
                    // Update another input field with the date 365 days after the selected date in yyyy-mm-dd format
                    $('#datepicker4').val(formattedDateAfter335);
                });
            });
            </script>
            <script>
            $(document).ready(function() {
                $('.store_table').click(function() {
                    ...
                    document.getElementById('table_iframe').src =
                        '<?php echo base_url('admin/table/load_store_tables_iframe/'); ?>' + storeId;
                });
            });
            </script>