                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <input type="hidden" name="id" id="Projector_loc_id" value=""/>
                               <?php echo are_you_sure; ?></div>
                            <div class="modal-footer">
                              <button class="btn btn-primary" type="button" data-bs-dismiss="modal">No</button>
                              <button class="btn btn-secondary" id="yes_del_Projector_loc" type="button" data-bs-dismiss="modal">Yes</button>
                            </div>
                          </div>
                        </div>
                      </div>
           ...
           <div class="row">
              ...
              <div class="col-sm-12">
                ...
                if(isset($projDet[0]['id'])) {
                    $path=base_url().'projector/edit_location';
                    $button_text='Update';
                    $button_name='edit';
                }else{
                    $path= base_url().'projector/add_location';
                    $button_text='Add new location';
                    $button_name='add';
                }?>
                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="mb-3">
                            ...
                            <input class="form-control" value="<?php if(isset($projDet[0]['location'])){echo $projDet[0]['location']; }else{ echo set_value('location'); } ?>" type="text" name="location">
                          </div>
              
                          <?php if(form_error('location')){ ?>
<div class="errormsg" location="alert"><?php echo form_error('location'); ?></div>
                  <?php } ?>
                        </div>
                       ...
                       <tr>
                            ...
                            <td> 
                              <ul class="action pull-right">
                                <li class="delete">
                                    <form action="<?php echo base_url();?>projector/edit_location" method="post">
                                      <input type="hidden" name="id" value="<?php echo $val['id']; ?>"> 
                                        <button type="submit" data-bs-toggle="tooltip" data-id="<?php echo $val['id']; ?>" data-bs-original-title="Edit Projector"><i class="fa fa-edit"></i></button>
                                    </form>
                                </li>
                                <li class="edit">
                                        <button class="del_Projector_loc" type="button" data-bs-toggle="modal" data-id="<?php echo $val['id']; ?>" data-bs-original-title="Delete Projector Location" data-bs-target="#exampleModal"><i class="fa fa-close"></i></button>
                                </li>
                              </ul>
                            </td>
