                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                <h4 class="mb-sm-0 font-size-18">Variants</h4>
 ...
 $date=date("d",$time);  ?>
                ...
                if(isset($variantDet[0]['variant_id'])) {
                    ...
                    <input type="hidden" name="id" value="<?php  if(isset($variantDet[0]['variant_id'])){echo $variantDet[0]['variant_id'];}?>">
                    
                    <div class="row bg-soft-light mb-3 border1 pt-2">

                       <div class="col-md-3">
                           <div class="mb-2 focus">
                               <label class="form-label" for="default-input">Variant Name</label>
                               <input class="form-control" value="<?php if(isset($variantDet[0]['variant_name'])){echo $variantDet[0]['variant_name']; }else{ echo set_value('variant_name'); } ?>" type="text" name="variant_name">
                               <?php if(form_error('variant_name')){ ?>
<div class="errormsg mt-2" role="alert"><?php echo form_error('variant_name'); ?></div>
      <?php } ?>
                           </div>
                       </div>
                       ...
                       <div class="col-md-3">
                           <div class="mb-2 focus">
                               ...
                               <input class="form-control" value="<?php if(isset($variantDet[0]['code'])){echo $variantDet[0]['code']; }else{ echo set_value('code'); } ?>" type="text" name="code">
                ...
                <td class="pb-0 pt-0 d-flex">
                    <form class="m-0" action="<?php echo base_url();?>admin/variants/edit" method="post">
                                      <input type="hidden" name="id" value="<?php echo $val['variant_id']; ?>"> 
                                        <button class="btn tblEditBtn pl-0 pr-0" type="submit" data-bs-toggle="tooltip" data-id="<?php echo $val['variant_id']; ?>" data-bs-original-title="Edit Variant"><i class="fa fa-edit"></i></button>
                    </form>
                    
                    <a class="btn tblDelBtn pl-0 pr-0 del_variant" type="button" data-bs-toggle="modal" data-id="<?php echo $val['variant_id']; ?>" data-bs-original-title="Delete Variant" data-bs-target="#exampleModal"><i class="fa fa-trash"></i></a>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <button class="btn btn-secondary" id="yes_del_variant" type="button" data-bs-dismiss="modal">Yes</button>
                            </div>
                          </div>
                        </div>
                      </div>
