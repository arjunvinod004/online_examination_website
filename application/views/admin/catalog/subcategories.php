 ...
 $date=date("d",$time);  ?>
                    ...
                    <div class="alert alert-danger dark" role="alert">
                        ...
                        <div class="">
                            ...
                            <a class="btn btn-primary mb-2 f-right" href="<?php echo base_url(); ?>admin/subCategories/add" role="button"><i class="fa fa-plus"></i> Add Sub Category</a>
        ...
        <?php
            ...
            <tr>
                ...
                <td class="pb-0 pt-0 d-flex">
                    <form class="m-0" action="<?php echo base_url();?>admin/subCategories/edit" method="post">
                                      <input type="hidden" name="id" value="<?php echo $val['subcategory_id']; ?>"> 
                                        <button class="btn tblEditBtn pl-0 pr-0" type="submit" data-bs-toggle="tooltip" data-id="<?php echo $val['subcategory_id']; ?>" data-bs-original-title="Edit Category"><i class="fa fa-edit"></i></button>
                    </form>
                    
                    <a class="btn tblDelBtn pl-0 pr-0 del_category" type="button" data-bs-toggle="modal" data-id="<?php echo $val['subcategory_id']; ?>" data-bs-original-title="Delete Category" data-bs-target="#exampleModal"><i class="fa fa-trash"></i></a>
