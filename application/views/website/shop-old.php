...
<style>
  ...
  #productDetails .modal-content {
    border-radius: 0; /* Optional: Removes the rounded corners */
  }
.product {
    margin-bottom: 20px;
}
                    ...
                    <div class="cover-card-main-over1">
                        ...
                        <ul class="nav-h_top language p-0">
                            ...
                            <div class="row">
                                ...
                                <h2 class="title-left"><?php echo $store_informations->store_name; ?> </h2>
...
<a href="<?php echo site_url() ?>cart/view"><p class="cart-total" style="color: #fff;font-size: 16px;font-size: 16px;font-weight: bold;"><span id="total-items">0 Items Added <span id="cart-total"></span></p></a>
</div>
