...
<div class="row">
    ...
    <div class="">
        <div class="table-responsive-sm">
            ...
            $query = $this->db->query("SELECT rate, tax, tax_amount, total_amount ,is_default, is_active FROM store_variants WHERE variant_id = ".$val['variant_id']." AND store_id = ".$this->session->userdata('logged_in_store_id')." AND store_product_id = ".$store_product_id."");
            ...
            <!-- Button column -->
            <div class="col-auto">
                <a class="btn btn-primary f-right mt-0" data-id="<?php echo $store_product_id; ?>" id="add_variant"
                    disabled>ADD</a>
                <a class="btn btn-primary f-right mt-0" id="update_variant" disabled>UPDATE</a>
            </div>
