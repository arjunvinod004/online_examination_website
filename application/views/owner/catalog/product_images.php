...
<div class="container">
    ...
    <div class="gallery-item">
      <img src="<?php echo base_url(); ?>uploads/product/<?php echo $image['image']; ?>">
      <button class="set_default btn btn-primary" data-image="<?php echo $image['image']; ?>" data-id="<?php echo $store_product_id; ?>">Set Default</button>
    </div>
    <div class="gallery-item">
      <img src="<?php echo base_url(); ?>uploads/product/<?php echo $image['image1']; ?>">
      <button class="set_default btn btn-primary" data-image="<?php echo $image['image1']; ?>" data-id="<?php echo $store_product_id; ?>">Set Default</button>
    </div>
    <div class="gallery-item">
      <img src="<?php echo base_url(); ?>uploads/product/<?php echo $image['image2']; ?>">
      <button class="set_default btn btn-primary" data-image="<?php echo $image['image2']; ?>" data-id="<?php echo $store_product_id; ?>">Set Default</button>
    </div>
    <div class="gallery-item">
      <img src="<?php echo base_url(); ?>uploads/product/<?php echo $image['image3']; ?>">
      <button class="set_default btn btn-primary" data-image="<?php echo $image['image3']; ?>" data-id="<?php echo $store_product_id; ?>">Set Default</button>
    </div>
    <?php } ?>
  </div>
