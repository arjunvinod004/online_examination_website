...
<div class="row">
    ...
    <div class="accordion-item">
        ...
        <div id="collapseOrder1" class="accordion-collapse collapse show" aria-labelledby="headingOrder1" data-bs-parent="#orderAccordion">
            <div class="accordion-body">
                ...
                <button class="btn btn-primary update-order-quantities" data-order-id="1">Update Quantities</button>
            </div>
        </div>
    </div>
</div>
  ...
  $(document).ready(function() {
    ...
    $('.update-order-quantities').click(function() {
        ...
        $('#collapseOrder' + orderId + ' .product-item').each(function() {
            var productId = $(this).find('input[type="number"]').attr('id').replace('quantity', ''); // Extract product ID
            var quantity = parseInt($(this).find('input[type="number"]').val()); // Get the quantity value
